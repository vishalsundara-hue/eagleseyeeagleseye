...
export function StatCard({
  ...
  const accents: Record<string, string> = {
    cyan: "from-sky-400/30 to-cyan-300/10 text-primary border-cyan-400/30",
    rose: "from-rose-500/30 to-rose-400/10 text-rose-700 border-rose-400/30",
    amber: "from-amber-500/30 to-amber-300/10 text-amber-700 border-amber-400/30",
  ...
  return (
    <div className="glass rounded-2xl p-4 sm:p-5 flex items-center gap-4">
      ...
      <div className="min-w-0">
        ...
        <div className="text-2xl sm:text-3xl font-bold text-foreground leading-tight tabular-nums">{value}</div>
